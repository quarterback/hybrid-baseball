...
# A typical 0.50 stamina arm gets ~80 pitches before the pitch-count cliff;
# elite stamina stretches the budget, low stamina collapses much earlier.
PITCH_FATIGUE_BUDGET_BASE: float = 35.0
PITCH_FATIGUE_BUDGET_SCALE: float = 90.0
PITCH_FATIGUE_SCALE: float = 25.0
PITCH_FATIGUE_MAX: float = 0.75
PITCH_FATIGUE_EFFECT_SCALE: float = 0.75
