...
_CONFERENCES: list[tuple[str, str, list[tuple[str, str, str, float, float]]]] = [
    ("Southeastern", "South", [
        ...
        ("Kentucky Wildcats",              "KEN", "Lexington KY",       38.04, -84.50),
        ("Auburn Tigers",                  "AUB", "Auburn AL",          32.61, -85.48),
        ("Ole Miss Rebels",                "MISS","Oxford MS",          34.37, -89.52),
    ]),
    ("Big Plains", "Plains", [
        ("Oklahoma Sooners",               "OKLA","Norman OK",          35.22, -97.45),
        ("Oklahoma State Cowgirls",        "OKST","Stillwater OK",      36.12, -97.07),
    ...
    ("Frontier Independents", "Frontier", [
        ...
        ("Hawaii Rainbow Wahine",          "HAW", "Honolulu HI",        21.31, -157.82),
