    ...
    },
    {
        ...
        "entries": [
            ...
            {"key": "ppp_babip", "abbr": "PP-BABIP", "name": "Power Play BABIP-against",
             "desc": "Batting average on balls in play allowed while the pitcher had the nickel deployed behind him. Lower means the loaded defense suppressed more hits — a defense-dependent number, read as support, not skill."},
            {"key": "ppp_babip_split", "abbr": "BABIP Δ", "name": "Power Play BABIP Split",
             "desc": "PP-BABIP minus the pitcher's BABIP-against without the nickel. Negative = the 10th fielder lowered his BABIP-against; the defensive bailout isolated on a familiar scale."},
            {"key": "ppp_k_pct", "abbr": "PP-K%", "name": "Power Play Strikeout Rate",
             "desc": "Strikeouts per batter faced while the nickel was deployed. Defense-independent — strikeouts never reach the extra fielder — so this is genuinely the pitcher's, isolating whether the presence lift made him nastier."},
            ...
            {"key": "ppp_coverage", "abbr": "PP-Cov%", "name": "Power Play Coverage",
             "desc": "Share of the pitcher's total outs recorded with the nickel behind him. A usage/protection measure of how much the manager shields this arm — not a result stat."},
            ...
            {"key": "ppp_hits_saved", "abbr": "H-Saved", "name": "Hits Saved Behind Him",
             "desc": "Singles the nickel ran down for outs while this pitcher was on the mound. Defensive support received, not a pitcher-quality metric."},
            {"key": "ppp_xbh_saved", "abbr": "XBH-Saved", "name": "Extra-Base Hits Saved Behind Him",
             "desc": "Extra-base hits the nickel held to singles while this pitcher was on the mound. Support received, not merit."},
        ],
    },
    {
