...
GLOSSARY_SECTIONS: list[dict] = [
    {
        ...
        "entries": [
            ...
            {"key": "avg", "abbr": "AVG", "name": "Batting Average",
             "desc": "Alias of PAVG (H / PA) in the native view. On the leaderboard's MLB-Equivalent (XO) cards it's the crossover-scaled value; natively O27 leads with PAVG."},
            {"key": "obp", "abbr": "OBP", "name": "On-Base Percentage",
             "desc": "Rate of reaching base safely, PA-denominated: (H + BB + HBP) / PA."},
            {"key": "slg", "abbr": "SLG", "name": "Slugging Percentage",
             "desc": "Total bases per plate appearance (TB / PA) — weights extra-base hits by their base value. PA-denominated like the rest of O27's rate stats, so it reads cleanly across multi-hit 2C at-bats."},
            ...
            {"key": "iso", "abbr": "ISO", "name": "Isolated Power",
             "desc": "SLG − PAVG (both PA-denominated) = extra bases per plate appearance. Measures raw extra-base power, stripping out singles."},
    ...
    },
    {
        ...
        "entries": [
            ...
            {"key": "ppp_babip", "abbr": "PP-BABIP", "name": "Power Play BABIP-against",
             "desc": "Batting average on balls in play allowed while the pitcher had the nickel deployed behind him. Lower means the loaded defense suppressed more hits."},
            {"key": "ppp_babip_split", "abbr": "BABIP Δ", "name": "Power Play BABIP Split",
             "desc": "PP-BABIP minus the pitcher's BABIP-against without the nickel. Negative = the 10th fielder lowered his BABIP-against."},
            {"key": "ppp_k_pct", "abbr": "PP-K%", "name": "Power Play Strikeout Rate",
             "desc": "Strikeouts per batter faced while the nickel was deployed. Defense-independent — strikeouts never reach the extra fielder."},
            {"key": "ppp_bb_pct", "abbr": "PP-BB%", "name": "Power Play Walk Rate",
             "desc": "Walks per batter faced while the nickel was deployed. Defense-independent (lower is better)."},
            {"key": "ppp_coverage", "abbr": "PP-Cov%", "name": "Power Play Coverage",
             "desc": "Share of the pitcher's total outs recorded with the nickel behind him — how often the manager has the extra fielder out there for this arm."},
            {"key": "ppp_bf", "abbr": "PP-BF", "name": "Power Play Batters Faced",
             "desc": "Batters faced with the nickel deployed behind him."},
            {"key": "ppp_hits_saved", "abbr": "H-Saved", "name": "Hits Saved Behind Him",
             "desc": "Singles the nickel ran down for outs while this pitcher was on the mound."},
            {"key": "ppp_xbh_saved", "abbr": "XBH-Saved", "name": "Extra-Base Hits Saved Behind Him",
             "desc": "Extra-base hits the nickel held to singles while this pitcher was on the mound."},
        ],
    },
    {
    ...
    },
    {
        ...
        "entries": [
            ...
            {"key": "game_equiv", "abbr": "GE", "name": "Game Equivalents",
             "desc": "Total workload expressed in complete-game-worths (one full O27 game = 27 outs), so total_outs / 27. The Out-Share-native synthetic workload number; synthetic IP is just GE × 9."},
