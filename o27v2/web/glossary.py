    ...
    },
    {
        ...
        "entries": [
            ...
            {"key": "tto_hardhit_delta", "abbr": "TTOΔ", "name": "Times-Through Hard-Hit Δ",
             "desc": "Change in hard-hit% allowed from the 1st time facing a hitter in a game to the 3rd+ time. Positive = hitters square him up more with familiarity; flat/negative = he resists being timed up (the deception arbitrage). Contact-quality only; strikeout-by-look splits need engine-side TTO counters."},
