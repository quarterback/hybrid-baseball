...
A baseball variant compressed into one continuous 27-out half-inning per side. Cricket's T20 ethos applied to baseball — the same total outs, restructured into a single arc that changes the strategic shape of the sport. Unlike my last attempt at a fake computer sport [https://github.com/quarterback/viperball](Viperball), this one has been in my head for a long time. I've surely tweeted about it before, presupposing you could "Cricket Baseball" but shortening the game somehow. I debated between a 5 inning game and ending it, but tests with that when I started here made it clear that'd just be "short, more random and even more boring baseball. When I considered 27 outs/1 innings, it felt like "ohhh...now this is a marathon and a sprint all at once" 
